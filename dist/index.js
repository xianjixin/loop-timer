...
class LoopTimer {
    ...
    _executeFunc(info) {
         ...
         */
        if (info.func.constructor.name === "AsyncFunction" && (info.executeStatus === iLoopTimer_1.eExcuteStatus.UNEXECUTED || info.executeStatus === iLoopTimer_1.eExcuteStatus.END)) {
